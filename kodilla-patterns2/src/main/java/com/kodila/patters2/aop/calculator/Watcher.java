package com.kodila.patters2.aop.calculator;
...
public class Watcher {
    ...
    @Before("execution(* com.kodila.patters2.aop.calculator.Calculator.factorial(..))" +
    ...
    @Around("execution(* com.kodila.patters2.aop.calculator.Calculator.factorial(..))")
